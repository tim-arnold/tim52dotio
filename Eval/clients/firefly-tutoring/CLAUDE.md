# Firefly Tutoring — Remediation Audit

## Project

Remediation audit for **https://www.fireflytutoring.com**. The goal is to identify and prioritize issues to fix on the existing site — no rebuild is planned.

## Client

- **Name:** Firefly Tutoring
- **Public URL:** https://www.fireflytutoring.com
- **Previous domain:** N/A
- **CMS:** Wix
- **Hosting:** Wix
- **Local site path:** N/A
