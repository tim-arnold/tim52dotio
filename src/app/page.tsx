                ...
                <div className={styles.aboutContent}>
                    <ParallaxElement speed={0.3} direction="right" className={styles.aboutText}>
                        ...
                        <p>
                            ...
                            while I was playing drums for a bunch of bands in <a href="https://rawheadrex.bandcamp.com/album/tang-o-the-void">Eugene</a>
                            (which is in <a href="https://youtu.be/Eo8FmXeuS0A?si=jghw6fvf2gh9Z3fs">Oregon</a>), <a
