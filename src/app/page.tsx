                    ...
                    <div className="container">
                        <div className={styles.heroContent}>
                            <div className={styles.heroText}>
                                <h1 id="hero-heading">Web Developer &amp;<br />Tech Leader</h1>
                                <p className={styles.heroLead}>
                                    I help nonprofits build websites and make technology work for them.
                                    25 years leading tech teams at agencies taught me what succeeds and
                ...
                <section id="ask-ai" className={styles.aiSection} aria-labelledby="ai-heading">
                    <div className="container">
                        ...
                        <p className={styles.aiIntro}>
                            Ask my AI assistant anything about my background, or paste a job
                            description for an honest assessment.
                        </p>
                        <AIInterface />
                    </div>
                </section>
